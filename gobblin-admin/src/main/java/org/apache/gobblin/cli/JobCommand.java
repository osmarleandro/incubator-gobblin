        ...
        throws CommandException {
            try {
                if (parsedOpts.hasOption(NAME_OPT)) {
                    ...
                    JobInfoPrintUtils.printAllJobs_RENAMED(adminClient.queryAllJobs(QueryListType.RECENT, resultsLimit), resultsLimit);
                } else {
                    JobInfoPrintUtils.printAllJobs_RENAMED(adminClient.queryAllJobs(QueryListType.DISTINCT, resultsLimit), resultsLimit);
                }
