...
public MetricContext getMetricContext(DefaultGobblinInstanceDriverImpl defaultGobblinInstanceDriverImpl) {
    return defaultGobblinInstanceDriverImpl._metricCtx;
  }
