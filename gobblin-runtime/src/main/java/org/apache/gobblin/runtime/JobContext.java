...
public void onJobCompletion(AbstractJobListener abstractJobListener) throws Exception {
    if (abstractJobListener._log.isPresent()) {
      abstractJobListener._log.get().info("jobCompletion: " + this);
    }
  }
}
